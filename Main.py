...
jpath = "C:/Users/muham/AppData/Local/Programs/Julia-1.7.2/bin/julia.exe" # path to Julia, from current directory (your path may be slightly different)
...
Main.include('bac.jl')
Main.include('motion_estimation.jl')
